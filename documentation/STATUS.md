...
**Verified ground truth (2026-07-23):** `pytest tests/ --ignore=tests/stripe_sync` = **587 pass / 0 fail**, `mypy src/` = **23 errors / 9 files** (pre-existing baseline), verified 2026-07-24 after the POL-12 engine change. **Committed locally 2026-07-23** (branch `feature/us-018-mypy`, ahead of origin, unpushed). Canonical docs: STATUS (state) · IDEAL_STATE (vision) · KNOWLEDGE (business facts).
