...
| S-4 | **Corpus (bucket G → retriever)** | UNBLOCKED (apply done) — persist the 6,944 G-lines via the audited bridge into `CategorizationRetriever`; then wire RAG into Phase 4D. |
